...
(function () {
  ...
  function applyFilter(button) {
    ...
    document
      .querySelectorAll("[data-filter-target='" + target + "']")
    ...
    document
      .querySelectorAll("button[data-filter-target='" + target + "']")
  ...
  function activateTab(button) {
    ...
    document
      .querySelectorAll("[data-tab-group='" + group + "'][data-tab]")
      .forEach(function (peer) {
  ...
  function applySearch(input) {
    ...
    document
      .querySelectorAll("[data-search-target='" + target + "']")
      .forEach(function (item) {
